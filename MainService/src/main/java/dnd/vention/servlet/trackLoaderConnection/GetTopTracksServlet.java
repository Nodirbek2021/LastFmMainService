...
@WebServlet("/v1/api/secured/trackLoader/getTopTracks")
public class GetTopTracksServlet extends HttpServlet {
    @SneakyThrows
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String tracksFromDBAsJSon = GetTopTracksService.respondJson(page);
