...
import dnd.vention.service.trackLoader.service.GetTopTracksByArtistNameService;
import dnd.vention.service.trackLoader.service.GetTopTracksService;
...
@WebServlet("/v1/api/secured/trackLoader/getTopTracksByArtistName")
public class GetTopTracksByArtistNameServlet extends HttpServlet {
    @SneakyThrows
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String tracksFromDBAsJSon = GetTopTracksByArtistNameService.respondJson(artistName,page);
        ApiResponse apiResponse=new ApiResponse(true,"tracks",tracksFromDBAsJSon);
        Gson gson=new Gson();
